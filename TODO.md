...
* [x] Dashboard empty state polish — new globe SVG illustration (replaces generic mountains), updated headline + subtitle, 4 feature badge pills (Plan Trips / Interactive Map / Smart Itinerary / Travel Journal), removed misleading "Free forever" tagline
